...
def _fallback(incident_id):
    order=[("get_anomaly_event",{}),("get_channel_breakdown",{}),("get_daypart_breakdown",{}),("get_peer_comparison",{}),("get_operational_signals",{}),("get_external_signals",{}),("get_recommended_actions",{}),("run_what_if",{"delivery_recovery":.75,"promotion_uplift":0})]
    trace=[]; data={}
